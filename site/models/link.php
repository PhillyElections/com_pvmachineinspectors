...
/**
 * @version		$Id: reset.php 21046 2011-03-31 16:11:40Z matthew.murphy $
 *
...
class UserModelReset extends JModel {
	 ...
	 * @return bool True on success/false on failure
	 */
	public function confirmReset($token, $username) {
		global $mainframe;
	 ...
	 * @return bool True on success/false on failure
	 */
	public function completeReset($password1, $password2) {
		jimport('joomla.user.helper');
