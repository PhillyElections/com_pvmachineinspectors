...
<?=JText::_('Name');?>:
    ...
    <td>
        ...
        <?=JHTML::_('select.genericlist', PVCombo::gets('prefix'), 'prefix', 'class="inputbox required"', 'idx', 'value', PVCombo::get('prefix', PVCombo::keySearch('prefix', $applicant->prefix)), 'prefix', true)?>
        ...
        <?=JHTML::_('select.genericlist', PVCombo::gets('suffix'), 'suffix', 'class="inputbox required"', 'idx', 'value', PVCombo::get('suffix', PVCombo::keySearch('suffix', $applicant->suffix)), 'suffix', true)?>
        <?=JHTML::_('select.genericlist', PVCombo::gets('suffix'), 'suffix1', 'class="inputbox required"', 'idx', 'value', 1, 'suffix1', true)?>
        <?=JHTML::_('select.genericlist', PVCombo::gets('suffix'), 'suffix2', 'class="inputbox required"', 'idx', 'value', 'Mr', 'suffix2', true)?>
    </td>
...
<?=JText::_('State');?>:
    ...
    <td>
<?=JHTML::_('select.genericlist', PVCombo::gets('state'), 'region', 'class="inputbox required"', 'idx', 'value', ($applicant->region ? $applicant->region : 'PA'), 'region', true)?>
</td>
</tr>
<tr>
    <td height="40">
