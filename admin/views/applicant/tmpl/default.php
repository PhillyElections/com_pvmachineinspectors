...
<?=JText::_('Name');?>:
    ...
    <td>
        <?=JHTML::_('select.genericlist', PVCombo::gets('prefix'), 'prefix', 'class="inputbox required"', 'idx', 'value', PVCombo::get('prefix', PVCombo::keySearch('prefix', $applicant->prefix)), true)?>
        ...
        <?=JHTML::_('select.genericlist', PVCombo::gets('suffix'), 'suffix1', 'class="inputbox required"', 'idx', 'value', 1, true)?>
        <?=JHTML::_('select.genericlist', PVCombo::gets('suffix'), 'suffix2', 'class="inputbox required"', 'idx', 'value', 'Mr', true)?>
    </td>
